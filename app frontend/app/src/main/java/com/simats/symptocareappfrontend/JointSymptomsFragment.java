...
public class JointSymptomsFragment extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_joint_symptoms, container, false);

        setupToggle(view, R.id.sympJointPain);
        setupToggle(view, R.id.sympStiffness);
        setupToggle(view, R.id.sympSwelling);
        setupToggle(view, R.id.sympMuscleAches);
        setupToggle(view, R.id.sympLimitedMotion);
